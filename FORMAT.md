...
All fields are little-endian uint32. A 168-byte header precedes variable-length
...
`192 + 4 * PROFILER_PMU_COUNT + 4 * PROFILER_STACK_UNWIND` bytes. A 64 KiB buffer holds 2,723 samples
